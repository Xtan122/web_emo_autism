<template>
  <div class="min-h-screen md:pl-64 pt-6 bg-slate-50">
    ...
    <div class="max-w-2xl mx-auto px-6 pb-20">
      ...
      <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 flex flex-col md:flex-row items-center gap-8 mb-8">
        <div class="relative">
          <img :src="store.userInfo.avatar" class="w-32 h-32 rounded-full object-cover border-4 border-blue-100 shadow-md" alt="Avatar">
          <button class="absolute bottom-0 right-0 bg-blue-500 text-white w-10 h-10 rounded-full flex items-center justify-center border-4 border-white shadow-sm hover:bg-blue-600 transition">
        ...
        <div class="space-y-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              <div class="w-10 h-10 bg-blue-50 text-blue-500 rounded-full flex items-center justify-center text-lg">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              <div class="w-10 h-10 bg-purple-50 text-purple-500 rounded-full flex items-center justify-center text-lg">
      ...
      <button @click="handleLogout" class="w-full md:hidden bg-slate-100 text-slate-500 font-bold py-4 rounded-2xl hover:bg-slate-200 transition">
